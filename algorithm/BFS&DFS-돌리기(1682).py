...
visited = set()
queue = deque([(0, (1, 2, 3, 4, 5, 6, 7, 8))])
while queue:
    i, numbers = queue.popleft()
    ...
    for numbers in (
            numbers[4:][::-1] + numbers[:4][::-1],
            numbers[3:4] + numbers[0:3] + numbers[5:] + numbers[4:5],
            numbers[:1] + numbers[2:3] + numbers[5:6] + numbers[3:4] + numbers[4:5] + numbers[6:7] + numbers[1:2] + numbers[7:],
            numbers[4:5] + numbers[1:4] + numbers[:1] + numbers[5:]
    ):
        if numbers not in visited:
            visited.add(numbers)
            queue.append((i + 1, numbers))
